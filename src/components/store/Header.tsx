...
export default function Header() {
  ...
  return (
    <>
      {/* Topbar */}
      <div className="bg-gradient-to-r from-rose-deep to-rose-darker text-white text-center py-2 px-4 text-xs font-medium tracking-wide">
        🎀 Frete grátis para compras acima de{' '}
        <span className="text-gold-shine font-bold">R$ 199</span>{' '}
        · Pagamento 100% seguro via{' '}
        <span className="text-gold-shine font-bold">Pix ou Cartão</span>
      </div>
